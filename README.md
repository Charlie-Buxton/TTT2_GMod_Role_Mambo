...
Mambo is a detective role who can temporarily call a dead player back as a spirit. The spirit cannot walk, speak, or use normal weapons. Instead, the Mambo has a short window to ask questions while the spirit answers with audible `Yes` and `No` sounds.
